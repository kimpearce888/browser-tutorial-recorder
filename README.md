...
[![Tests: 175](https://img.shields.io/badge/Tests-175%20passing-success)](./test-suite.mjs)
...
[![Version: 2.0.5](https://img.shields.io/badge/Version-2.0.5-ff7352)](./manifest.json)

**Version: v2.0.5** — a complete, from-scratch rewrite of the recording engine built for reliability.
...
├── test-suite.mjs             # Automated test suite (175 tests)
...
- **175 automated tests** covering `recorder-core.js`, `shared.js`, `settings-store.js`, `gif-encoder.js`, `exporter.js`, and the real `content.js` (evaluated in jsdom)
