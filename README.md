...
[![Tests: 464](https://img.shields.io/badge/Tests-464%20passing-success)](./test-suite.mjs)
...
[![Version: 2.2.1](https://img.shields.io/badge/Version-2.2.1-ff7352)](./manifest.json)

**Version: v2.2.1** — a complete, from-scratch rewrite of the recording engine built for reliability.
...
- **464 automated tests** covering `recorder-core.js`, `shared.js`, `settings-store.js`, `gif-encoder.js`, `exporter.js`, `cursor-marker.js`, `annotation-geom.js`, the real `content.js` (evaluated in jsdom), the full background ⇄ content message bus, and a static import/export cross-check of every module
