...
[![Tests: 162](https://img.shields.io/badge/Tests-162%20passing-success)](./test-suite.mjs)
...
[![Version: 2.0.4](https://img.shields.io/badge/Version-2.0.4-ff7352)](./manifest.json)

**Version: v2.0.4** — a complete, from-scratch rewrite of the recording engine built for reliability.
...
├── test-suite.mjs             # Automated test suite (162 tests)
...
- **162 automated tests** covering `recorder-core.js`, `shared.js`, `settings-store.js`, `gif-encoder.js`, `exporter.js`, and the real `content.js` (evaluated in jsdom)
