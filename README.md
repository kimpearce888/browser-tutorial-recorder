...
[![Tests: 133](https://img.shields.io/badge/Tests-133%20passing-success)](./test-suite.mjs)
...
[![Version: 2.0.0](https://img.shields.io/badge/Version-2.0.0-ff7352)](./manifest.json)

**Version: v2.0.0** — a complete, from-scratch rewrite of the recording engine built for reliability.
...
## Architecture (v2.0.0 — fresh rewrite)
...
├── test-suite.mjs             # Automated test suite (133 tests)
...
- **133 automated tests** covering `recorder-core.js`, `shared.js`, `settings-store.js`, `gif-encoder.js`, `exporter.js`, and the real `content.js` (evaluated in jsdom)
